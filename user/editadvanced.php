...
if ($userform->is_cancelled()) {
	...
	$usernew->descriptionformat='1';
        ...
        // BK -- Missing error in database query for field descriptionformat
        //$usernew->descriptionformat='text';
        // BK
        // print_r();exit;
	$usernew->descriptionformat='1';
...
$userid = $USER->id;
$allowEdit = 0;
$admin = user_has_role_assignment($userid, 1, $contextid = 0); 
$manager = user_has_role_assignment($userid, 10, $contextid = 0); 
if($admin || $manager){
    $allowEdit = 1;
}
...
$(document).ready(function(){
    let allowEdit = "<?php echo $allowEdit ?>";
    if(allowEdit == 1){
        $('#id_moodle').show();
    }  
});
