...
?>
    ...
    <script src="chart/jquery.dvstr_jqp_graph.min.js" type="text/javascript"></script>
    <script src="chart/raphael-2.1.4.min.js"></script>
    <script src="chart/justgage.js"></script>
