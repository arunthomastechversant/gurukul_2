...
class admin_uploaduser_form1 extends company_moodleform {
    public function definition () {
        ...
        //     $rd[$drive->id] = $drive->name;
        // } 
        $mform =& $this->_form;

        $mform->addElement('header', 'settingsheader', get_string('upload'));
        // $mform->addElement('select', 'drive_id', 'Choose a Recruitment Drive',$rd);
        // $mform->addRule('drive_id', null, 'required');
...
class admin_uploaduser_form2 extends company_moodleform {
    ...
    public function definition () {
        ...
        // $mform->addElement('hidden', 'driveid', $columns['driveid']);
