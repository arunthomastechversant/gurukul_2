...
require_once('create_company_manager.php');
...
$PAGE->set_title("Create Company Manager");
$PAGE->set_heading("Create Company Manager");
$PAGE->set_url($CFG->wwwroot.'/local/custompage/create_company_manager_form.php');
$coursenode = $PAGE->navbar->add('Create Company Manager', new moodle_url($CFG->wwwroot.'/local/custompage/create_company_manager.php'));
$PAGE->set_context(context_system::instance());
$linkurl = new moodle_url('/local/custompage/create_company_manager_form.php');
$return = $CFG->wwwroot.'/local/custompage/create_company_manager_form.php';
echo $OUTPUT->header();
$systemcontext = context_system::instance();
$companyid = iomad::get_my_companyid($systemcontext);
$mform = new companymanager_form($PAGE->url, $companyid, $departmentid, $licenseid);
