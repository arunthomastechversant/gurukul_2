...
require('../../config.php');
require_once('create_urdc_test.php');
require_login();
?>
...
$PAGE->set_title("Create URDC Test");
$PAGE->set_heading("Create URDC Test");
$PAGE->set_url($CFG->wwwroot.'/local/custompage/create_urdc_test_form.php');
$coursenode = $PAGE->navbar->add('Create Test', new moodle_url($CFG->wwwroot.'/local/custompage/create_urdc_test_form.php'));
...
$mform = new create_urdc_test_form();
if ($mform->is_cancelled()) {
    ...
    $urlto = $CFG->wwwroot.'/local/custompage/create_urdc_test_form.php';
