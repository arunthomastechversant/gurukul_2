...
if ($deleteid) {
    ...
    $result= $DB->delete_records('rsl_recruitment_drive', array('id'=>$deleteid));     
     redirect(new moodle_url('/local/custompage/rsl_recruitment_drive_list.php'),'recruitment_drive Deleted Sucessfully', 3);
}
...
redirect($urlto, 'Recruitment Drive Created Sucessfully ', 8);
