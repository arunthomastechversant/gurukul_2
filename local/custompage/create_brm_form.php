...
$PAGE->set_title("Add BT Reporting Manager");
$PAGE->set_heading("Add BT Reporting Manager");
$PAGE->set_url($CFG->wwwroot.'/local/custompage/create_brm_form.php');
$coursenode = $PAGE->navbar->add('Add BT Reporting Manager', new moodle_url($CFG->wwwroot.'/local/custompage/create_brm_form.php'));
$PAGE->set_context(context_system::instance());
$return = $CFG->wwwroot.'/local/custompage/create_brm_form.php';
echo $OUTPUT->header();
...
if ($mform->is_cancelled()) {
   ...
   // print_r($record);exit();
    ...
    $user->password = 'Brm@1'.password_generate(4);  
    $user->confirmed = 1;
    ...
    redirect($return, 'BRM Created Successfully ', 8);
