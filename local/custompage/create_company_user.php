...
class companyuser_form extends moodleform {
...
$companyid = iomad::get_my_companyid($systemcontext);
	...
	$mform->addElement('hidden', 'sendnewpasswordemails', 0);
	...
	// 	}
	// }
	$attributes = array("0"=>"User","16"=>"RSL Recruiter","3"=>"Interviewer");;
	$mform->addElement('select', 'managertype', 'Role',$attributes);
	$mform->addRule('managertype', get_string('required'), 'required', null, 'client');
