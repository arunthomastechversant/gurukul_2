...
$title = 'RSL Users Management';
$datas = $DB->get_records_sql("SELECT * FROM {rsl_user_detail} order by id DESC ");
$PAGE->set_title($title);
$PAGE->set_heading($title);
$PAGE->set_url($CFG->wwwroot.'/local/custompage/usermanagement.php');
$PAGE->navbar->add($title, new moodle_url('/local/custompage/usermanagement.php'));
require_login();
echo $OUTPUT->header();
$PAGE->set_context(context_system::instance());

$baseurl = new moodle_url('/local/custompage/usermanagement.php');
$i = 1;
...
echo '<button id="delete" class="btn btn-secondary" >Delete Users</button></br></br>';
