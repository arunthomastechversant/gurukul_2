...
$PAGE->set_heading('BT Users List'); 
$PAGE->set_url($CFG->wwwroot.'/local/custompage/bu_list.php');
$PAGE->navbar->add('BT Users List', new moodle_url('/local/custompage/bu_list.php'));
require_login();
echo $OUTPUT->header();
$PAGE->set_context(context_system::instance());

$baseurl = new moodle_url('/local/custompage/bu_list.php');
...
$add_organization = $CFG->wwwroot.'/local/custompage/create_bu_form.php';

echo '<a href="'.$add_organization .'" class="btn btn-secondary" >Add BT Users</a></br></br>';
