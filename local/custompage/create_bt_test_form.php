...
require('../../config.php');
require_once('create_bt_test.php');
require_login();
?>
...
$PAGE->set_title("Create BT Test");
$PAGE->set_heading("Create BT Test");
$PAGE->set_url($CFG->wwwroot.'/local/custompage/create_bt_test_form.php');
$coursenode = $PAGE->navbar->add('Create BT Test', new moodle_url($CFG->wwwroot.'/local/custompage/create_bt_test_form.php'));
...
if ($mform->is_cancelled()) {
    ...
    $urlto = $CFG->wwwroot.'/local/custompage/create_bt_test_form.php';
