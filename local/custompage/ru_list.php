...
$PAGE->set_title("RSL Users List");
$PAGE->set_heading("RSL Users List");
$PAGE->set_url($CFG->wwwroot.'/local/custompage/ru_list.php');
$PAGE->navbar->add('RSL Users List', new moodle_url('/local/custompage/ru_list.php'));
require_login();
echo $OUTPUT->header();
$PAGE->set_context(context_system::instance());

$baseurl = new moodle_url('/local/custompage/ru_list.php');
...
echo '<a href="'.$add_organization .'" class="btn btn-secondary" >Add RSL Users</a></br></br>';
