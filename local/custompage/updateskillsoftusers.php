...
require_once($CFG->dirroot.'/local/custompage/updateskillsoftusers_form.php');
...
$linktext = "Update Skill Soft User";
// Set the url.
$linkurl = new moodle_url('/local/custompage/updateskillsoftusers.php');
...
$returnurl = $CFG->wwwroot."/local/custompage/updateskillsoftusers.php";
...
// Array of all valid fields for validation.
    ...
    if ($formdata = $mform->get_data()) {
        ...
        while ($line = $cir->next()) {
            ...
            $userid = $DB->get_record('user', array('username' => $user->username))->id;
            if($userid !=""){            
                $userdriveid = $DB->get_record('rsl_user_detail', array('userid' => $userid))->id;
                $userdata = new stdclass();
                $userdata->id = $userdriveid;
                $userdata->course_was_launched = $user->course_was_launched;
                $userdata->course_status = $user->course_status;
                $userdata->completion = $user->completion;
                $userdata->test_score = $user->test_score;  
