...
require_once('create_bt_recruitment_drive.php');
require_login();
$PAGE->set_pagelayout('admin');
$PAGE->set_title("Add BT Recruitment Drive");
$PAGE->set_heading("Add BT Recruitment Drive");
$PAGE->set_url($CFG->wwwroot.'/local/custompage/create_bt_recruitment_drive_form.php');
$coursenode = $PAGE->navbar->add('Add BT Recruitment Drive', new moodle_url($CFG->wwwroot.'/local/custompage/create_bt_recruitment_drive_form.php'));
// $PAGE->set_context(context_system::instance());
//~ $url = $CFG->wwwroot.'/local/custompage/get_data.php';
$return = $CFG->wwwroot.'/local/custompage/bt_recruitment_drive_list.php';
echo $OUTPUT->header();


$mform = new create_bt_recruitment_drive_form();
...
$groupname= $data->name;
    ...
    $insert_record = $DB->insert_record('bt_recruitment_drive', $record);


$urlto = $CFG->wwwroot.'/local/custompage/bt_recruitment_drive_list.php';
