...
class qtype_vplquestion_edit_form extends question_edit_form {
    ...
    protected function definition_inner($mform) {
        ...
        $PAGE->requires->js_call_amd(QVPL.'/editform', 'setup', array($acetheme, $templatechangehelp));
    }
    ...
    public function validation($submitteddata, $files) {
        ...
        if ($submitteddata['validateonsave']) {
            ...
            try {
                $result = evaluate($submitteddata['teachercorrection'], $question, false);
                $grade = extract_fraction($result, $question->templatevpl);
