...
$string['cannotimportquestionvplunreachable'] = 'Attention : le VPL sp&eacute;cifi&eacute; dans la Question VPL "{$a}" n\'est pas dans ce cours.';
...
$string['vplnotavailablewarning'] = 'Attention ! Le VPL utilis&eacute; comme base par cette question n\'est pas disponible. La question peut ne pas fonctionner correctement.';
