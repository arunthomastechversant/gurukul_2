...
$string['clickflag'] = 'Mark to attempt later';
$string['clicktoflag'] = 'Flag this question for future reference';
$string['clicktounflag'] = 'Remove Mark';
$string['clickunflag'] = 'Remove Mark';
...
$string['markedoutofmax'] = '{$a} mark for correct answer';
