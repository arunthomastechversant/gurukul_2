...
if (!isset($_POST['SAMLResponse']) || isset($_REQUEST['option'])) 
{
    ...
    elseif (isset($_REQUEST['option']) && $_REQUEST['option'] == 'mosaml_metadata' ) {
        mo_saml_miniorange_generate_metadata();
    }
    elseif (isset($_REQUEST['option']) && $_REQUEST['option'] == 'mosaml_metadata_download' ) {
...
//	}
//	set_config('rolesfromidp', $rolesfromidp, 'auth/mo_saml');
//
