...
<br><button id="snap" class="snap-photo">Take My Picture</button><button id="save" class="snap-photo" style="margin-left:5px;">Save Picture</button>
</td>
...
$userid=$USER->id;
echo '<script src="'.$CFG->wwwroot.'/local/custompage/js/jquery-1.11.2.min.js"></script>';
?>
<!-- <script src="http://localhost/gurukul/local/custompage/js/jquery-1.11.2.min.js"></script> -->
<script>
	...
	$( "#snap" ).click(function() {
	    checkDeviceSupport(function() {
            if(isWebcamAlreadyCaptured == true){
    		 ...
    		 alert('Please Enable Webcam and Take Picture');
            }
        });
	})
