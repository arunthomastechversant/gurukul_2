...
function theme_moove_set_loginbgimg($theme) {
    ...
    // $loginbgimg = "";
    // if ($files = $fs->get_area_files(5, 'local_custompage', 'loginbg',false, 'sortorder', false)) 
    // {
    //     foreach ($files as $key => $file) 
    //     {
    //         $loginbgimg = moodle_url::make_pluginfile_url(5, 'local_custompage', 'loginbg', $file->get_itemid(), $file->get_filepath(), $file->get_filename());
    //         $loginbgimg = $loginbgimg->__toString();
    //     }
        
    // }
    $headercss = "#page-login-index.moove-login #page-wrapper #page {background-image: url('$loginbgimg');}";
    // $headercss = "#page-login-index.moove-login #page-wrapper #page {background-image: url('/image/login_bg.jpg');}";
